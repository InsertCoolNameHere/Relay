...
class IPTrainerLight(pl.LightningModule):

    # INIT OF GENERATOR AND DISCRIMINATOR
    def __init__(self, sample_percent):
        super(IPTrainerLight, self).__init__()
        self.save_on = False
        random.seed(7)
    ...
    def validation_step(self, batch, batch_nb):
        ...
        _, y_hat = self.model(x, x1)

        loss1 = self.l1_criterion(y_hat * inv_mask, y * inv_mask)
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        if self.current_epoch == 10:
            ...
            if "lattice-181" in self.hostname:
                ...
                save_model(self.model, "GLOBAL", {}, self.val_loss1, 2, isTL=True)
    ...
    def training_step(self, batch, batch_nb):
        ...
        loss = self.l1_criterion(y_hat * inv_mask, y * inv_mask)
